...
This Helm Chart deploys a Large Language Model (LLM)-enabled [chat bot application](https://github.com/redhat-developer/rhdh-ai-template/tree/main/samples/chatbot).
...
### The Application
A [Streamlit](https://github.com/streamlit/streamlit) application to interact with the model service which is based on the related [Chatbot Template](https://github.com/redhat-developer/rhdh-ai-template/tree/main/templates/chatbot/content).
...
- Access to an OpenShift 4.x cluster with
	...
	- correctly [installed](https://www.redhat.com/en/technologies/cloud-computing/openshift/pipelines) and [configured](https://github.com/redhat-developer/rhdh-ai-template/blob/main/charts/README.md#openshift-pipelines) OpenShift Pipelines Operator which is connected to your GitHub Applications webhook
...
| Name | Email | Url |
| ---- | ------ | --- |
| Red Hat Developer Hub Development Teams |  | <https://github.com/redhat-developer> |
| Red Hat Developer Hub AI Development Team |  | <https://github.com/redhat-ai-dev> |
## Source Code

* <https://github.com/redhat-developer/rhdh-ai-template>
## Requirements
...
| gitops.gitSourceRepo | string | `"redhat-developer/rhdh-ai-template"` | The Github Repository with the contents of the ai-lab sample chatbot application under `samples/` |
