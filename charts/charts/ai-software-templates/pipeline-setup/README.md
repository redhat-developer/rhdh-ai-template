...
that OpenShift Pipelines can run the Tekton Pipelines under the [rhdh-pipelines](https://github.com/redhat-developer/rhdh-ai-template-pipelines) repo, and that
